...
Запускаем Code::Blocks в меню Settings > Compiler... выбираем вкладку Toolchain executables и нажимаем кнопку Auto-detect  
Система должна определить папку в которую установлен компилятор, например D:\dev\mingw64\mingw32
