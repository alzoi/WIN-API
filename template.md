...
void DrawEx(HWND p_hWnd) {
	...
	if (hdc) {
		...
		// Вывод текста длиной 15 символов из точки (100,70) - левый верхний угол первого смвола.
		TextOut(hdc, 100, 70, L"Строка String 世", 15);
		
		// Создаём в памяти буфер для 256 символов UNICODE.
		wchar_t Buf[256];
		// Копируем строку "Test 世" в буфер, получаем длину перенесённых символов
		// и выводим это количество символов на печать в рабочую область окна.
		TextOut(hdc, 100, 170, Buf, wsprintf(Buf, L"Test 世"));		
	}
