...
Для выполнения операций компиляции исходных кодов на языке C/C++ и сборки исполняемых программ (*.exe файлов) необходимо подготовить рабочее окружение (создать необходимые переменные, настроить пути к библиотекам, заголовкам и SDK).
...
```
Основной скрипт для сборки приложения находится в файле vcvarsall.bat.
