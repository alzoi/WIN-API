...
Чтобы объявить литерал широких символов (для хранения символа используется более 1 байта, то есть колировка Unicode) или строковый литерал широких символов, необходимо поставить L перед литералом
```c
wchar_t a = L'a';
wchar_t *str = L"hello";
...
# Сборка программ
Утилита gcc это колекция компиляторов C, C++, Objective-C, Fortran , Ada, Go и D.  
